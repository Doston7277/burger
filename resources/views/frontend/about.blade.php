    ...
    <div class="gallery_area">
        ...
        @foreach($gallerys as $gallery)
            <div class="single_gallery big_img">
                <a class="popup-image" href="{{ asset('uploads/gallery/' . $gallery->image) }}">
                    <i class="ti-plus"></i>
                </a>
                <img width="100%" src="{{ asset('uploads/gallery/' . $gallery->image) }}" alt="">
            </div>
        @endforeach
    </div>
            ...
            @foreach($instagrams as $instagram)
                <div class="col-lg-3 col-md-6">
                    <div class="single_instagram">
                        <img src="{{ asset('uploads/instagram/' . $instagram->image) }}" alt="#">
                        <div class="ovrelay">
                            <a href="#">
